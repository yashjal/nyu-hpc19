...
******************************************************************************/
// Unlock a, b after initialization, otherwise the each thread in the section (before adding) waits for either a or b to be unlocked by the other thread, causing deadlock
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
#define N 1000000
